...
Nécessite un fichier DUMP en MySql de la BD : /database/Surdez_Leonardo_INFO1D_164_DUMP
"""
import os
import re
...
class ToolsBd:
    ...
    def extract_name_bd_from_dump_file():
        ...
        But : Extrait la chaîne de caractère du nom de la base de donnée contenu dans le fichier :
                    "Surdez_Leonardo_INFO1D_164_DUMP"
    ...
    def test_cmd_CRD_file_dump_sql():
        ...
        Tester si il y a des problèmes éventuels sur le fichier : "Surdez_Leonardo_INFO1D_164_DUMP"
        ...
        try:
            if os.path.exists(NAME_FILE_DUMP_SQL_BD):
                fichier_dump_sql_bd = open(NAME_FILE_DUMP_SQL_BD, "r", encoding="utf8")
                lignes_fichier_dump = fichier_dump_sql_bd.read()
                """Si le fichier DUMP en SQL "../database/Surdez_Leonardo_INFO1D_164_DUMP" existe, 
