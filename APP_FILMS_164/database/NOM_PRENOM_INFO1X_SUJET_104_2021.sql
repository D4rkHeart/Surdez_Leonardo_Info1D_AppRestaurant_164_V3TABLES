...
INSERT INTO `t_genre` (`id_pays`, `nom`, `updated_at`) VALUES
...
CREATE TABLE `t_genre_film` (
  `id_pays_film` int(11) NOT NULL,
  `fk_genre` int(11) DEFAULT NULL,
  `fk_film` int(11) DEFAULT NULL,
  `date_insert_pays` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `t_genre_film` (`id_pays_film`, `fk_genre`, `fk_film`, `date_insert_pays`) VALUES
...
--
ALTER TABLE `t_genre`
  MODIFY `id_pays` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT pour la table `t_genre_film`
--
ALTER TABLE `t_genre_film`
  MODIFY `id_pays_film` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
--
...
--
ALTER TABLE `t_genre_film`
  ADD CONSTRAINT `t_genre_film_ibfk_1` FOREIGN KEY (`fk_genre`) REFERENCES `t_genre` (`id_pays`),
